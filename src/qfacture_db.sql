...
--
-- Serveur: localhost
-- Généré le : Ven 31 Décembre 2010 à 16:53
...
CREATE TABLE IF NOT EXISTS `facture` (
  ...
  `Type` enum('FACTU','DEVIS') DEFAULT NULL COMMENT 'FACTU ou DEVIS',
...
INSERT INTO `facture` (`fID`, `u_ID`, `c_ID`, `tr_ID`, `amount`, `comment`, `Type`, `Date`) VALUES
(1, 1, 1, 1, '4010.14', 'tata description', 'FACTU', '2010-10-19');
